...
class Calculadora(tk.Tk):
    ...
    def _creacion_componentes(self):
        ...
        #primer renglon
        #boton limpiar
        boton_limpiar = tk.Button(botones_frame, text='C', width='32', height=3, bd=0,
                                 bg='#eee', cursor='hand2', command=self._evento_limpiar)
        ...
        #Quinto renglon
        boton_cero = tk.Button(botones_frame, text='0', width=21, height=3, bg='#fff',
    ...
    def _evento_evaluar(self):
        #eval evalua la expresion str una expresion artimetica
        try:
            if self.expresion:
    ...
    def _evento_click(self, elemento):
        #concatenamos el nuevo elemtno a la expresion ya existente
